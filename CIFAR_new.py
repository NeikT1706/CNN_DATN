...
optimizer = optim.Adam(model_qat.parameters(), lr=0.001, weight_decay=1e-5)

# Training loop (Huấn luyện lại mô hình QAT)
for epoch in range(10):  # Ít epoch hơn do QAT mất nhiều thời gian
    model_qat.train()
    running_loss = 0.0
...
torch.save(model_qat.state_dict(), "model_cifar_qat.pth")
